...
public class MainActivity2 extends AppCompatActivity {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(document!=null){
                    ...
                    Picasso.with(MainActivity2.this).load(img).into(imageView);
                    //btn noi
    ...
    private void speak() {
        textToSpeech.speak(textViewnoidung.getText().toString(),TextToSpeech.QUEUE_FLUSH,null);
    }
    ...
    private void init() {
        //anh xa
        textViewnoidung =(TextView) findViewById(R.id.txtnoidung);
        textViewtime =(TextView) findViewById(R.id.txttime);
        textViewtitle =(TextView) findViewById(R.id.txttitle);
        imageView =(ImageView) findViewById(R.id.imgcon);

        back_drop = findViewById(R.id.back_drop);

        btnnho = (Button) findViewById(R.id.btn1);
        btnvua =(Button) findViewById(R.id.btn2);
        btnlon = (Button) findViewById(R.id.btn3);
        //btnngay dem
        scrollView =(NestedScrollView) findViewById(R.id.nested_scroll_view);
        btndem =(Button) findViewById(R.id.btnlight2);
        btnngay =(Button) findViewById(R.id.btnlight1);
        //btn noi
        btnnoi =(Button) findViewById(R.id.btnReader1);
        btntamdung =(Button) findViewById(R.id.btnReader2);
